		...
		<div className="relative isolate pt-24 pb-32 sm:pt-32">
			...
			>
				<div
					...
					className="ml-[-22rem] aspect-1313/771 w-328.25 flex-none origin-top-right rotate-30 bg-linear-to-tr from-green-500 to-green-800 xl:mr-[calc(50%-12rem)] xl:ml-0"
				/>
			</div>
