...
export default function NavesIndustriales() {
	return (
		<>
			{/* Hero Section */}
			<ImageHeader title={info.title} backgroundImage={"https://res.cloudinary.com/dbl4j1i1f/image/upload/v1754513873/smart-panel.banner-aplicaciones-aulas-scaled_jm0fqx.png"} />
			{/* Description */}
